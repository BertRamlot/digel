...
HD_PWD='C:/Users/bertr/digel/W4/W4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addsub_display.tcl
