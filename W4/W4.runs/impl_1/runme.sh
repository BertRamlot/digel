...
HD_PWD='C:/Users/bertr/digel/W4/W4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source addsub_display.tcl -notrace
