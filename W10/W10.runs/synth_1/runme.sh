...
HD_PWD='C:/Users/bertr/digel/W10/W10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s1r1_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s1r1_board.tcl
