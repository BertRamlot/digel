...
HD_PWD='C:/Users/bertr/digel/W5/W5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log button_test_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source button_test_board.tcl -notrace
