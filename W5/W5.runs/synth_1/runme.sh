...
HD_PWD='C:/Users/bertr/digel/W5/W5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log button_test_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source button_test_board.tcl
