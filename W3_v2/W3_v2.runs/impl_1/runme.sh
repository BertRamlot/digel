...
HD_PWD='C:/Users/bertr/digel/W3_v2/W3_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcdtoseg_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcdtoseg_board.tcl -notrace
