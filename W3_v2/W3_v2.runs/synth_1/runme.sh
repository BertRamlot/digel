...
HD_PWD='C:/Users/bertr/digel/W3_v2/W3_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcdtoseg_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcdtoseg_board.tcl
